    ...
    if CHAN1_STATE == 1:
        ...
        for i in range(0,50):
            ...
            if not os.path.exists(ChDataFilePath):
                ...
                print('Channel 1 Data saved as:\n' + saveDir + '/' + "Ch1Data_%d.dat" %i)
                break
    ...
    if CHAN2_STATE == 1:
        ...
        for i in range(0,50):
            ...
            if not os.path.exists(ChDataFilePath):
                ...
                print('Channel 2 Data saved as:\n' + saveDir + '/' + "Ch2Data_%d.dat" %i)
                break
    ...
    if CHAN3_STATE == 1:
        ...
        for i in range(0,50):
            ...
            if not os.path.exists(ChDataFilePath):
                ...
                print('Channel 3 Data saved as:\n' + saveDir + '/' + "Ch3Data_%d.dat" %i)
                break
    ...
    if CHAN4_STATE == 1:
        ...
        for i in range(0,50):
            ...
            if not os.path.exists(ChDataFilePath):
                ...
                print('Channel 4 Data saved as:\n' + saveDir + '/' + "Ch4Data_%d.dat" %i)
                break
